...
import com.example.a20230131_glennwhite_nycschools.di.Injector;
import com.example.a20230131_glennwhite_nycschools.model.remote.NYCSchoolSat;
import com.example.a20230131_glennwhite_nycschools.model.state.ERROR;
...
public class SchoolDetails extends Fragment {
   ...
   private SchoolViewModel viewModel;
    ...
    private final SchoolViewModelProvider schoolViewModelProvider = Injector.getInstance().provideProvider();
